...
*See: [Why Ceres: The Case for the Belt]({{< ref "ceres/why-ceres" >}}) — the case for the Ceres node.*
*See: [The Settlement: Permanent Presence]({{< ref "ceres/ceres-settlement" >}}) — what Ceres produces that Psyche needs.*
