...
## The Inter-Lake Dam Wall: Already Built

The most significant capital item for any Stage 2 northern boundary is Stage 1's southern dam wall, constructed as part of Stage 1 and operational before Stage 2 commences.

Stage 1's southern dam wall was designed as: the primary load-bearing dam retaining Stage 1 lake water on its northern face against an excavated transition zone to the south. That transition zone — a 10km band of managed shallow wetland south of the wall — was always Stage 2's staging area.

When Stage 2 proceeds:

**Stage 1's southern dam wall becomes the inter-lake control node.** Not merely a boundary — an active management interface. Gated sluice structures through the wall allow:

- Controlled overflow from Stage 1 into Stage 2 during wet years when Stage 1 is at maximum managed level
- Throttled transfer of salt-concentrated water from Stage 1 to Stage 2 as a salinity management tool — routing elevated-salinity water southward rather than allowing it to accumulate in Stage 1
- Emergency drawdown of Stage 1 into Stage 2 if Stage 1 dam embankments require inspection or maintenance

The inter-lake wall is the system's operational brain. It separates two managed water bodies at different elevations and salinities while allowing controlled transfer between them. Nothing equivalent needs to be built — it exists.

**Cost implication:** The northern boundary of Stage 2, which would represent the largest single capital item in a standalone Stage 2 project, was funded by Stage 1. This is not accounting sleight of hand — it is the correct reading of staged infrastructure where each phase deliberately positions the next.
...
An extreme inflow event overwhelming Stage 1 gate control can be partially managed by opening the inter-lake sluices fully, flooding Stage 2 rapidly and absorbing surplus volume. Stage 2 becomes the system's pressure relief valve — engineered buffer against the consequences of a 1-in-500 year event coinciding with gate failure.
...
## Indigenous Partnership: Arabana Country Southward

The Arabana people's country extends south through the Kati Thanda South basin. The same partnership principles established for Stage 1 apply to Stage 2, with one additional dimension:

Stage 2's higher salinity and halophytic ecology may more closely resemble historical lake conditions that Aboriginal oral tradition describes — Kati Thanda at natural fill is brackish rather than freshwater, and some Dreaming accounts of the lake's productive phases may encode memory of conditions closer to Stage 2's salinity target than Stage 1's freshwater-adjacent design.

Stage 2 ecological planning should explicitly incorporate Arabana knowledge of the southern basin's historical ecology — species present in productive periods, water behaviour, seasonal patterns. This knowledge is not supplementary to the design process; it is primary data about how this specific ecosystem has functioned under similar conditions.

The Arabana Cultural Authority's formal involvement in Stage 2 ecological baseline design — not approval, but co-design — is both ethically correct and technically superior to proceeding without it.
