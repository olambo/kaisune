...
tags:
  ...
  - long-horizon
description: "The Earth governance documents describe reform within existing constraints. This document describes what governance looks like when those constraints are gone. Ceres governance is not a reform proposal. It is a founding question — what architecture emerges when the governors don't age, don't die, have no electoral cycle, and are designing from scratch for minds operating on century timescales."
---

## Summary

The two preceding governance documents address Earth systems — why democratic architecture structurally cannot authorise civilisational-scale projects, and what reform would be sufficient to change that. Those documents are prescriptive proposals for existing institutions under existing constraints.
...
One governance principle must be established at Ceres founding, before the transition technology matures, before the legal question becomes politically contested.
...
The corpus bootstraps the conditions. It identifies the founding questions. It establishes one founding principle that must be answered before the technology makes the question urgent.

The constitution is theirs to write.
